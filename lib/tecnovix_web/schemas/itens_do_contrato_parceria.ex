defmodule Tecnovix.ItensDoContratoParceriaSchema do
  ...
  schema "itens_do_contrato_parceria" do
    field :contrato_de_parceria_id, :integer
  ...
  def changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:contrato_de_parceria_id, :descricao_generica_do_produto_id, :filial, :contrato_n, :item, :produto,
    :quantidade, :preco_venda, :total, :cliente, :loja])
